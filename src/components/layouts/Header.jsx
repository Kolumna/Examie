...
import { MdAccountCircle, MdHelp, MdTextDecrease, MdTextIncrease } from "react-icons/md";
    ...
    <section className="px-8 bg-slate-50 py-5 w-full flex items-center shadow-md">
      <div className="flex justify-between w-full">
        ...
        <div className="items-center gap-4 hidden md:flex">
          <button className="font-black bg-slate-200 w-8 h-8 rounded-full flex justify-center items-center"><MdTextDecrease/></button>
          <button className="font-black bg-slate-200 w-8 h-8 rounded-full flex justify-center items-center"><MdTextIncrease/></button>

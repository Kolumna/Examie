              ...
              {!loading &&
                data.modules[
                  ...
                  switch (item.type) {
                    ...
                    case "important":
                      return (
                        <ImportantField key={item.value} value={item.value} />
                      );
                    ...
                    default:
                      return (
                        <p className="text-red-500 font-bold">
                          Błędny typ paragrafu "<strong>{item.type}</strong>"
                        </p>
                      );
                  }
                })}
            ...
            <footer className="flex justify-end gap-4">
              {lesson && (
                ...
                >
                  ...
                  {
                    names[
                      names.indexOf(lesson) - 1 ? names.indexOf(lesson) - 1 : 0
                    ]
                  }
                </button>
              )}
